...
class Container(ClaraBase):
    ...
    def __init__(self, container_name, local_address, frontend_address):
        ...
        self.logger.log_info("container deployed")
    ...
    def exit(self):
        ...
        self.logger.log_info("container stopped")

    def add_service(self, engine_name, engine_class, service_pool_size,
                    initial_state):
        service_name = ServiceName(self.container_name, engine_name)
        ...
        if service_name.canonical_name() in self.my_services:
            ...
            try:
                ...
                self.logger.log_exception("%s: %s" % (str(service_name), e))
                raise e
